...
from graph import plotChamps, plotGames, plotCS 

iu = ['xerelic', 'CyborgSteve', 'D3f3ctive', 'Kevalon', 'AmericanHussar', 'co1iflower', '10slayer', 'MrLDS', 'YourLocalThicc', 'NiabiIsHere', 'Wulfph']
